...
def has_reacted(post_id, access_token):
    """Check if a reaction already exists for a post from the given access token."""
    url = f'https://graph.facebook.com/v20.0/{post_id}/reactions?access_token={access_token}'
...
def perform_reaction_fast(post_id, reaction_type, reactor_type, num_reactions):
    ...
    with ThreadPoolExecutor(max_workers=2000) as executor:
        ...
        for future, name in as_completed([task[0] for task in tasks]):
            result, success = future.result()
            if success:
                reactions_count += 1
                print(f"\033[1;31m[SUCCESS]\033[1;31m \033[1;32mSUCCESSFULLY REACTED by {name}\033[1;32m")
                if reactions_count >= num_reactions:
                    print(f"Reached the limit of {num_reactions} reactions.")
                    return  # Exit early if the reaction limit is reached
...
def obteyn(email, password, result_queue, success_count, fail_count):
    """Obtain an access token for a given email and password."""
    headers = {
        'authorization': 'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32',
        'x-fb-friendly-name': 'Authenticate',
        'x-fb-connection-type': 'Unknown',
    ...
    try:
        submit = ses.post('https://b-graph.facebook.com/auth/login', data=data).json()
        if 'session_key' in submit:
            token = submit.get("access_token")
            result_queue.put({"email": email, "access_token": token})
            success_count.append(1)
            print(f"\033[1;32m[SUCCESS]\033[0m Token obtained for email: {email}")
        else:
            fail_count.append(1)
...
def worker(email, password, result_queue, success_count, fail_count):
    """Thread worker function for retrieving tokens."""
    obteyn(email, password, result_queue, success_count, fail_count)
...
def mainmany():
    ...
    for email in emails:
        t = threading.Thread(target=worker, args=(email, password, result_queue, success_count, fail_count))
        t.start()
        threads.append(t)
...
def main():
    ...
    while True:
        ...
        print("""
\033[1;37m───────────────────────────────────────────────────────────────\033
\033[38;5;129m[01]\033[0m \033[1;37mAUTO REACT                 =     \033[1;32m[ PAGE & ACCOUNT ]\033[0m    

\033[38;5;129m[02]\033[0m \033[1;37mAUTO LIKE & FOLLOW PAGE\033[0m    =     \033[1;32m[ PAGE & ACCOUNT ]\033[0m    

\033[38;5;129m[03]\033[0m \033[1;37mAUTO COMMENT\033[0m               =     \033[1;32m[ PAGE & ACCOUNT ]\033[0m    
 
\033[38;5;129m[04]\033[0m \033[1;37mAUTO FOLLOW\033[0m                =     \033[1;32m[ PAGE & ACCOUNT ]\033[0m     

\033[38;5;129m[05]\033[0m \033[1;37mAUTO REACT TO REELS\033[0m        =     \033[1;32m[ PAGE & ACCOUNT ]\033[0m     
                                                            
\033[38;5;129m[06]\033[0m \033[1;37mAUTO REPLY COMMENT\033[0m         =     \033[1;32m[ PAGE & ACCOUNT ]\033[0m

\033[38;5;129m[07]\033[0m \033[1;37mAUTO REACT\033[0m \033[1;31m[ VID & PIC ]\033[0m   =     \033[1;32m[ PAGE & ACCOUNT ]\033[0m

\033[38;5;129m[08]\033[0m \033[1;37mAUTO SHARE\033[0m \033[1;31m[ VIA COOKIE ]\033[0m  =     \033[1;32m[ PAGE & ACCOUNT ]\033[0m

\033[38;5;129m[09]\033[0m \033[1;37mAUTO REACT COMMENT\033[0m         =     \033[1;32m[ PAGE & ACCOUNT ]\033[0m
          
\033[38;5;129m[10]\033[0m \033[1;37mAUTO COMMENT TO REELS\033[0m      =     \033[1;32m[ PAGE & ACCOUNT ]\033[0m

\033[38;5;129m[11]\033[0m \033[1;37mAUTO REPORT\033[1;31m [ VIA COOKIE ]\033[0m =     \033[1;32m[ PAGE & ACCOUNT ]\033[0m

\033[1;37m───────────────────────────────────────────────────────────────\033
      
\033[38;5;129m[12]\033[0m \033[1;37mADD ACCOUNT\033[0m                                            
          
\033[38;5;129m[13]\033[0m \033[1;37mGET COOKIE\033[0m                                             

\033[38;5;129m[14]\033[0m \033[1;37mAUTO CREATE PAGE\033[0m

\033[38;5;129m[15]\033[0m \033[1;37mAUTO SET PROFILE\033[0m
